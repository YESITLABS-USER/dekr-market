  ...
  return (
    <>
        ...
        <div className="hero-sec has-texture">
            <div className="texture circle-texture"  ><Image  
                       src={circleTexture}  alt="Texture Image"/></div>
                ...
                <div className="hero-inr row">
                    ...
                    <div className="hero-body">
                        ...
                        <div className="hero-content">
                            <p>Dekr combines real-time market signals with interactive financial education and an AI chat coach to help you invest confidently—even if you&#39;re just starting out.</p>
                            <a href="#url" className="cmn-btn"  data-bs-target="#joinModal" data-bs-toggle="modal">Join the Waitlist</a>
                            <p  className="hero-content-btm-txt">or <a href="#url">Join our Discord</a> to help shape the future of investing together.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6">
                            <div className="goals-right">
                                <h3>Smart investing turns “maybe someday” into “definitely happening”:</h3>
                                ...
                                <p>With Dekr, you’re not just throwing darts—you’re taking shots with a coach who knows where the target is.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="container">
                <div className="performance-inr">
                    <div className="sec-head head-warm-pink text-center mb-5">
                        ...
                        <p>Smart investing isn&#39;t luck—it&#39;s strategy. Here&#39;s the proof:</p>
                    </div>
                    <div className="performance-table">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                   <td><p>NASDAQ-100</p> <p>Buy and Hold (QQQ)</p></td>
                                    <td>+154%</td>
                                    <td>+25%</td>
                                </tr>
                                <tr>
                    ...
                    <div className="performance-sec-notes">
                        <p>That&#39;s nearly $5,000 more—simply by following smarter signals.</p>
                        <p className="head-para">Lesson: Catch the right trends, and you ride higher.</p>
                    </div>
                </div>
            </div>
        </div>
