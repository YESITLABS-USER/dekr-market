...
const Community = () => {
  return (
    <>
      <div className="community-sec has-texture" id="community">
            ...
            <div className="cmn-list-wrp">
              ...
              <div className="cmn-list">
                <ul>
                  ...
                  <li>
                    A movement to make investing simple, social, and actually
                    enjoyable
                  </li>
                </ul>
              </div>
            </div>
            <p className="head-para text-uppercase">
